...
<div align="center">
  ...
  <a href="mailto:mrhyperionai@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
  <a href="https://www.linkedin.com/in/bagchisouvik/">
...
I'm a **B.Tech CSE (Data Science)** student at **Sikkim Manipal Institute of Technology**, passionate about building revolutionary software and exploring the depths of AI. I actively contribute to the developer ecosystem as a **Google Campus Ambassador**, **Google Cloud Innovator**, and **Open Source Connect Campus Lead**.

*   🔭 I’m currently working on **PurixOS** & **Voxtrona Music**
...
*   💬 Ask me about **Kotlin, Android, Next.js, or Cloud Computing**
...
|:---:|:---|:---:|
| <img src="https://github.com/MrHyperIon101/Voxtrona-Music/raw/main/app/src/main/ic_launcher-playstore.png" width="50" style="border-radius:10px;" /><br/>**[Voxtrona Music](https://voxtrona.souvikbagchi.social/)** | Premium music streaming app with Liquid Glass UI, lossless audio, and AI-powered features. Includes spatial audio & gapless playback. | `Kotlin` `Jetpack Compose` `AI` `Android` |
| <img src="https://img.icons8.com/fluency/48/console.png" width="50" /><br/>**[PurixOS](https://www.purixos.tech/)** | Revolutionary custom operating system with a custom kernel and unique visual language, optimized for speed and security. | `C++` `Assembly` `System Programming` |
| <img src="https://img.icons8.com/fluency/48/fast-food.png" width="50" /><br/>**[QuickByte](https://quickb.vercel.app/)** | AI-powered food ordering platform with smart recommendations, QR ordering, and real-time tracking. | `Next.js` `TypeScript` `AI` `UPI` |
| <img src="https://img.icons8.com/fluency/48/artificial-intelligence.png" width="50" /><br/>**[TechBuild AI](https://techbuildai.vercel.app/)** | Sophisticated AI platform for PC building. Generates compatible builds and provides upgrade advice using Gemini. | `Next.js` `Gemini` `Genkit` `ShadCN` |
...
<table>
  <tr>
    <td width="50%">
      <h3>☁️ Cloud & AI</h3>
      <ul>
        <li><strong>Google Cloud Security Summit (APAC)</strong></li>
        <li><strong>Generative AI with Vertex AI</strong> - Google Cloud</li>
        <li><strong>Azure Cognitive Services</strong> - Microsoft</li>
        <li><strong>Machine Learning Pipelines</strong> - Azure ML Studio</li>
      </ul>
    </td>
    <td width="50%">
      <h3>🏅 Badges & Programs</h3>
      <ul>
        <li><strong>Google Campus Ambassador</strong></li>
        <li><strong>Postman Student Leader</strong></li>
        <li><strong>GitHub Developer Program Member</strong></li>
        <li><strong>NVIDIA Developer Program Member</strong></li>
      </ul>
    </td>
  </tr>
</table>
...
<div align="center">
  ...
  <a href="https://twitter.com/mrhyperion101">
